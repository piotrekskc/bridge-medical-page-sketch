      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        <header className="text-center space-y-6 pt-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Your comprehensive guide to understanding the process, potential,
            and pathways to success in the European market.
          </p>
        </header>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent className="space-y-4 text-lg text-muted-foreground pt-6">
            ...
            <p>
              ...
              different approach to clinical validation. Each study is tailored
              to the device’s risk class, design, and intended purpose.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <CardContent className="space-y-4 text-lg text-muted-foreground pt-6">
            <p>
              ...
              ethical requirements. Devices are classified by risk level (Class
              I, IIa, IIb, III), which determines the extent of required
              clinical evidence and oversight.
            </p>
          </CardContent>
        </Card>
      </section>
