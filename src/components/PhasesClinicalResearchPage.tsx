  ...
  const phases = [
    {
      ...
      description: "This initial phase focuses on confirming the basic safety and functionality of the device in a controlled setting.",
      points: [
    ...
    },
    {
      ...
      description: "In this phase, the device is tested in a targeted patient population to evaluate its preliminary effectiveness and safety in real-world clinical settings.",
      points: [
    ...
    },
    {
      ...
      description: "Phase III represents the main regulatory trial required to support CE marking or market approval.",
      points: [
    ...
    },
    {
      ...
      description: "Once the device is approved and on the market, manufacturers must continue collecting clinical data to confirm long-term performance and detect any rare or delayed adverse effects.",
      points: [
    ...
    <div className="space-y-16 py-8">
      ...
      <section className="relative bg-gradient-to-r from-primary to-primary/80 text-white py-16">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold mb-4">Phases of Clinical Research</h1>
        ...
        <Card className="border-none shadow-lg">
          <CardContent className="p-8">
            ...
            <p className="text-lg leading-relaxed text-muted-foreground">
              Clinical investigations can be divided into several stages, depending on the development phase of the device and its regulatory needs. While they share some similarities with pharmaceutical trials, the design, goals, and endpoints are typically adapted for the specific nature of the medical device.
            </p>
          </CardContent>
        </Card>
      </section>
            ...
            <Card key={index} className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-start space-x-4">
                  <div className={`w-16 h-16 rounded-lg ${phase.color} flex items-center justify-center flex-shrink-0`}>
          ...
          <Card className="border-none shadow-lg">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed max-w-4xl mx-auto">
                Each phase of clinical research serves a specific purpose in the journey from concept to market. 
                Our expertise spans all phases, ensuring your medical device receives the comprehensive support 
                needed for successful regulatory approval and market entry across European markets.
              </p>
            </CardContent>
          </Card>
        </div>
