...
export function FAQPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      questions: [
        {
          question: "What approvals and documents are required before starting a clinical investigation?",
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Comprehensive answers to questions about clinical investigations and medical device research
          </p>
        </div>
          ...
          <Card className="border-none shadow-lg">
            <CardContent className="p-8">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Our team of clinical research experts is here to help. Contact us for personalized answers to your specific clinical investigation questions.
              </p>
